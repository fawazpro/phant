...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: 700;
            src: url(assets/Circular-Bold.ab51009b.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(assets/Inter-Regular.f744dc98.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: italic;
            font-weight: 400;
            src: url(assets/Inter-Italic.cc99ad32.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 500;
            src: url(assets/Inter-Medium.54afb6d9.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: italic;
            font-weight: 500;
            src: url(assets/Inter-MediumItalic.15785acc.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 600;
            src: url(assets/Inter-SemiBold.8bc2ab1d.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: italic;
            font-weight: 600;
            src: url(assets/Inter-SemiBoldItalic.a1bdb746.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 700;
            src: url(assets/Inter-Bold.e46cc865.woff) format("woff")
        }
        ...
        @font-face {
            ...
            font-style: italic;
            font-weight: 700;
            src: url(assets/Inter-BoldItalic.7c23f14e.woff) format("woff")
        }
    </style>
    ...
    <!-- <script async="" type="text/javascript" charset="utf-8"
        src="chrome-extension://bfnaelmomeimhlpmgjnjophhpkkoljpa/src.e59c6283.js"></script> -->
</head>
                ...
                <div class="sc-bZSRNg igRDVh">
                    <div class="sc-jJEKmz sc-hiSbEG bjOqkM hbxyrF"><svg width="94" viewBox="0 0 102 102" fill="none"
                            ...
                            <defs>
                                ...
                                <linearGradient id="paint0_linear" x1="51" y1="2" x2="51" y2="96"
                                    gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#534BB1"></stop>
                                    <stop offset="1" stop-color="#551BF9"></stop>
                                </linearGradient>
                                <linearGradient id="paint1_linear" x1="52" y1="19" x2="52" y2="81"
                                    gradientUnits="userSpaceOnUse">
                    ...
                    <section class="sc-citxvW kQRuto"><button font-size="16" width="100%" type="button"
                            class="sc-bdfBQB bzlPNH">Create New Wallet</button><button font-size="16" width="100%"
                            type="button" class="sc-bdfBQB fatHKg">Use Secret Recovery Phrase</button></section>
                </div>
            </div>
        </main>
        <br>
        <br>
        <main id="form" class="sc-iktFfs ivoYCk">
            <div style="opacity: 1;">
                <div opacity="1" class="sc-iwyWTf kPmQan">
                    <div color="#333333" opacity="1" class="sc-fKFxtB sc-bBXrwG hOFRHD eoqbIg"><svg width="5"
                            viewBox="0 0 5 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M0.216204 5.55076L3.5164 8.97446C3.80634 9.27525 4.28388 9.27525 4.57382 8.97446C4.86376 8.67367 4.86376 8.17825 4.57382 7.87746L1.81087 5.00226L4.58235 2.12706C4.87229 1.82627 4.87229 1.33085 4.58235 1.03006C4.43738 0.87967 4.24124 0.800049 4.05364 0.800049C3.8575 0.800049 3.66989 0.87967 3.52492 1.03006L0.224732 4.45376C-0.0737349 4.75455 -0.073735 5.24997 0.216204 5.55076Z">
                            </path>
                        </svg></div>
                ...
                <div class="sc-bZSRNg sc-iUuxjF igRDVh dmvHVY">
                    ...
                    <form>
                        <section class="sc-jcVcSv jjIfIs">
                            <div class="sc-iqHYmW ctDkzz"><textarea name="mnemonic" placeholder="Secret phrase"
                                    type="password" rows="3" font-size="16px"
                                    class="sc-bqyKOL sc-kstqJO khIMZB epkVnJ"></textarea></div>
                    ...
                    <div class="sc-dOSRxR fBdvZe"><button font-size="16" width="100%" type="button"
                            ...
                            <div class="sc-bBrNTY hFaEAq">
                                <div class="sc-cOajNj ixCjQo"><svg width="20" viewBox="0 0 20 16" fill="none"
                                    ...
                                    <path
                                        d="M7.63933 6.88208L2.13901 1.17591C1.65578 0.674598 0.859869 0.674598 0.376637 1.17591C-0.106595 1.67723 -0.106595 2.50293 0.376637 3.00425L4.98156 7.79624L0.362424 12.5882C-0.120808 13.0896 -0.120808 13.9153 0.362424 14.4166C0.60404 14.6672 0.930933 14.7999 1.24361 14.7999C1.5705 14.7999 1.88318 14.6672 2.1248 14.4166L7.62512 8.71041C8.12257 8.20909 8.12257 7.38339 7.63933 6.88208Z"
                                        fill="#666666"></path>
                                </svg>
                            </div>
                        </button><button font-size="16" width="100%" type="button" class="sc-bdfBQB dxwmeX">
                            <div class="sc-bBrNTY hFaEAq">
                                <div class="sc-cOajNj ixCjQo"><svg width="20" viewBox="0 0 15 15" fill="#fff"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M7.5 0C3.3589 0 0 3.3589 0 7.5C0 11.6411 3.3589 15 7.5 15C11.6411 15 15 11.6411 15 7.5C15 3.3589 11.6411 0 7.5 0ZM8.31288 11.7485C8.31288 12.0092 8.09816 12.2239 7.83742 12.2239H6.62577C6.36503 12.2239 6.15031 12.0092 6.15031 11.7485V10.9663C6.15031 10.7055 6.36503 10.4908 6.62577 10.4908H7.83742C8.09816 10.4908 8.31288 10.7055 8.31288 10.9663V11.7485ZM10.2301 7.08589C9.90798 7.53067 9.5092 7.88344 9.0184 8.14417C8.74233 8.32822 8.55828 8.51227 8.46626 8.72699C8.40491 8.86503 8.3589 9.04908 8.32822 9.2638C8.31288 9.43252 8.15951 9.55521 7.9908 9.55521H6.50307C6.30368 9.55521 6.15031 9.3865 6.16564 9.20245C6.19632 8.78834 6.30368 8.46626 6.47239 8.22086C6.68712 7.92945 7.07055 7.57669 7.6227 7.19325C7.91411 7.0092 8.12883 6.79448 8.29755 6.53374C8.46626 6.27301 8.54294 5.96626 8.54294 5.6135C8.54294 5.26074 8.45092 4.96932 8.25153 4.7546C8.05215 4.53988 7.79141 4.43252 7.43865 4.43252C7.14724 4.43252 6.91718 4.52454 6.71779 4.69325C6.59509 4.80061 6.5184 4.93865 6.47239 5.1227C6.41104 5.33742 6.21166 5.47546 5.98159 5.47546L4.60123 5.44479C4.43252 5.44479 4.29448 5.29141 4.30982 5.1227C4.35583 4.3865 4.64724 3.83436 5.15337 3.43558C5.7362 2.9908 6.48773 2.76074 7.43865 2.76074C8.45092 2.76074 9.24847 3.02147 9.83129 3.52761C10.4141 4.03374 10.7055 4.72393 10.7055 5.59816C10.7055 6.15031 10.5368 6.6411 10.2301 7.08589Z">
                                        </path>
                        ...
                        </button></div><button font-size="16" width="100%" type="button"
                        class="sc-bdfBQB bzlPNH">Finish</button>
